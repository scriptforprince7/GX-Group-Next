...
export const MobileNavbar = ({
  ...
  return (
    <div
      className={cn(
        'flex justify-between bg-transparent items-center w-full rounded-md px-2.5 py-1.5 transition duration-200 relative',
        showBackground &&
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-24 px-2 py-1 text-sm bg-neutral-800 text-white rounded-md border border-neutral-700 focus:outline-none focus:border-cyan-500 transition-colors"
                />
                <svg
                  className="absolute right-1.5 top-1/2 transform -translate-y-1/2 w-3 h-3 text-neutral-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
